...
### Linux
To download **Adoptium** (Temurin 17) for Linux, you can either download it as a portable package or using the system package manager. go [this page](https://adoptium.net/) and click on the **Other platforms and versions** button. Then choose the Linux operating system, other parameters and download the latest release.

1. Extract the archive in any folder you like.
2. Create a custom Bash file to run SKlauncher using the newly downloaded JRE/JDK:
   The command in it should look something like this:
       `[PATH TO TEMURIN]/bin/java -jar [PATH TO SKLAUNCHER]`
3. If you did everything correctly you will be able to run SKlauncher by running the Bash script.
